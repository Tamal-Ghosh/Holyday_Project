...
public class TourInstanceAdapter extends ListAdapter<TourInstance, TourInstanceAdapter.TourInstanceViewHolder> {
    ...
    public static class TourInstanceViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(TourInstance tourInstance, OnTourInstanceClickListener listener) {
            tourName.setText(tourInstance.getTourName() != null ? tourInstance.getTourName() : "N/A");
            shipName.setText(tourInstance.getShipName() != null ? tourInstance.getShipName() : "N/A");
            startDate.setText(tourInstance.getStartDate() != null ? tourInstance.getStartDate() : "N/A");
            endDate.setText(tourInstance.getEndDate() != null ? tourInstance.getEndDate() : "N/A");
